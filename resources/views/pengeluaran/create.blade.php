<x-app-layout>
    <x-slot name="header">
        <div style="display:flex;align-items:center;gap:1rem;">
            <a href="{{ route('pengeluaran.index') }}" style="display:flex;align-items:center;justify-content:center;width:36px;height:36px;border-radius:10px;background:rgba(255,255,255,0.04);border:1px solid var(--border);color:#94a3b8;text-decoration:none;transition:all 0.2s;" onmouseover="this.style.background='rgba(255,255,255,0.08)'" onmouseout="this.style.background='rgba(255,255,255,0.04)'">
            ...
            <div>
                ...
                <h1 class="font-display" style="font-size:1.4rem;font-weight:700;color:#e2e8f0;margin:0;">Catat Pengeluaran</h1>
            </div>
        </div>
    </x-slot>
        ...
        <div class="glass-card" style="overflow:hidden;">
            <div style="background:linear-gradient(135deg,rgba(244,63,94,0.1),rgba(225,29,72,0.05));padding:1.5rem;border-bottom:1px solid var(--border);">
                <div style="display:flex;align-items:center;gap:0.75rem;">
                    ...
                    <div>
                        <p style="font-size:0.875rem;font-weight:600;color:#e2e8f0;">Dana Keluar Gereja</p>
                        <p style="font-size:0.75rem;color:#64748b;">Isi semua detail transaksi pengeluaran dengan benar</p>
                    </div>
                </div>
            </div>
            ...
            <form action="{{ route('pengeluaran.store') }}" method="POST" enctype="multipart/form-data" style="padding:1.75rem;">
                ...
                <div style="margin-bottom:1.25rem;">
                    ...
                    <div style="border:2px dashed rgba(244,63,94,0.2);border-radius:14px;padding:1.5rem;text-align:center;cursor:pointer;transition:border-color 0.2s;position:relative;" id="dropzone" onmouseover="this.style.borderColor='rgba(244,63,94,0.4)'" onmouseout="this.style.borderColor='rgba(244,63,94,0.2)'">
                        ...
                        <div id="dropzoneContent">
                            ...
                            <p style="font-size:0.83rem;color:#94a3b8;">Klik atau drag & drop struk/nota</p>
                            <p style="font-size:0.72rem;color:#64748b;margin-top:0.2rem;">PNG, JPG hingga 2MB</p>
                        </div>
                    </div>
                </div>
                ...
                <div style="margin-bottom:1.75rem;padding:1rem;background:rgba(245,158,11,0.06);border:1px solid rgba(245,158,11,0.2);border-radius:14px;display:flex;align-items:center;gap:1rem;flex-wrap:wrap;">
                    <div>
                        ...
                        <p style="font-size:0.72rem;color:#64748b;margin-top:0.2rem;">Upload struk lalu klik scan untuk mengisi nominal & keterangan otomatis</p>
                    </div>
