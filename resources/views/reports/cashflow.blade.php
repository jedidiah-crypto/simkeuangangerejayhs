<x-app-layout>
    <x-slot name="header">
        <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:1rem;">
            <div>
                <p style="font-size:0.72rem;font-weight:600;color:#a78bfa;text-transform:uppercase;letter-spacing:0.1em;margin-bottom:0.2rem;">Laporan</p>
                <h1 class="font-display" style="font-size:1.4rem;font-weight:700;color:#e2e8f0;margin:0;">Laporan Arus Kas</h1>
    ...
    <div class="glass-card animate-in" style="padding:1.5rem;margin-bottom:1.5rem;overflow:hidden;">
        <div style="display:grid;grid-template-columns:1fr auto 1fr auto 1fr;gap:1rem;align-items:center;">
            ...
            <div style="text-align:center;">
                <p style="font-size:0.75rem;color:#94a3b8;margin:0;">Saldo Awal</p>
            ...
            <div style="text-align:center;">
                <svg width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="margin:0 auto;color:#94a3b8;">
            ...
            <div style="background:rgba(52,211,153,0.08);border:1px solid rgba(52,211,153,0.2);border-radius:12px;padding:1rem;text-align:center;">
                <p style="font-size:0.75rem;color:#64748b;margin:0;">Pemasukan</p>
            ...
            <div style="background:rgba(251,113,133,0.08);border:1px solid rgba(251,113,133,0.2);border-radius:12px;padding:1rem;text-align:center;">
                <p style="font-size:0.75rem;color:#64748b;margin:0;">Pengeluaran</p>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:1rem;margin-bottom:1.5rem;" class="animate-in">
        <div class="stat-card stat-emerald">
            ...
            <p style="font-size:1.5rem;font-weight:800;color:#e2e8f0;margin-top:0.4rem;font-family:'Sora',sans-serif;">+Rp {{ number_format($pemasukanTotal,0,',','.') }}</p>
        </div>
        <div class="stat-card stat-rose">
            ...
            <p style="font-size:1.5rem;font-weight:800;color:#e2e8f0;margin-top:0.4rem;font-family:'Sora',sans-serif;">-Rp {{ number_format($pengeluaranTotal,0,',','.') }}</p>
        </div>
    ...
    <div class="glass-card animate-in" style="overflow:hidden;">
        <div style="padding:1rem 1.5rem;border-bottom:1px solid var(--border);">
            <h3 style="color:#e2e8f0;font-size:0.9rem;font-weight:600;margin:0;">Ringkasan Arus Kas</h3>
        </div>
        <div style="padding:1.5rem;">
            <table style="width:100%;border-collapse:collapse;">
                <tr>
                    <td style="padding:1rem;color:#94a3b8;border-bottom:1px solid rgba(255,255,255,0.08);">Saldo Awal</td>
                    <td style="padding:1rem;text-align:right;color:#e2e8f0;border-bottom:1px solid rgba(255,255,255,0.08);font-weight:600;">Rp {{ number_format($saldoAwal,0,',','.') }}</td>
                </tr>
                <tr>
                    <td style="padding:1rem;color:#34d399;border-bottom:1px solid rgba(255,255,255,0.08);">Pemasukan</td>
                    <td style="padding:1rem;text-align:right;color:#34d399;border-bottom:1px solid rgba(255,255,255,0.08);font-weight:600;font-family:'Sora',sans-serif;">+Rp {{ number_format($pemasukanTotal,0,',','.') }}</td>
                </tr>
                <tr>
                    <td style="padding:1rem;color:#fb7185;border-bottom:1px solid rgba(255,255,255,0.08);">Pengeluaran</td>
                    <td style="padding:1rem;text-align:right;color:#fb7185;border-bottom:1px solid rgba(255,255,255,0.08);font-weight:600;font-family:'Sora',sans-serif;">-Rp {{ number_format($pengeluaranTotal,0,',','.') }}</td>
                </tr>
                <tr>
                    <td style="padding:1.25rem 1rem;color:#e2e8f0;background:rgba(255,255,255,0.04);border-radius:0 0 8px 8px;font-weight:700;">Saldo Akhir</td>
                    <td style="padding:1.25rem 1rem;text-align:right;color:{{ $selisih >= 0 ? '#34d399' : '#fb7185' }};background:rgba(255,255,255,0.04);border-radius:0 0 8px 8px;font-weight:700;font-family:'Sora',sans-serif;">
                        {{ $selisih >= 0 ? '+' : '-' }}Rp {{ number_format(abs($selisih),0,',','.') }}
                    </td>
                </tr>
            </table>
