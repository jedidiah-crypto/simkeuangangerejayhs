    ...
    <x-slot name="header">
        <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:1rem;">
            <div>
                ...
                <h1 class="font-display" style="font-size:1.4rem;font-weight:700;color:#e2e8f0;margin:0;">Laporan Pemasukan</h1>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:1rem;margin-bottom:1.5rem;" class="animate-in">
        ...
        @empty
            <div style="grid-column:1/-1;text-align:center;padding:3rem;">
                ...
                <p style="color:#64748b;">Tidak ada data pemasukan pada periode ini.</p>
            </div>
        @endforelse
    </div>
                ...
                @if(count($data) > 0)
                    <tfoot>
                        <tr>
                            ...
                            <td style="border-top:1px solid rgba(255,255,255,0.06);padding:0.75rem 1rem;"><span style="background:rgba(52,211,153,0.15);color:#34d399;padding:0.2rem 0.6rem;border-radius:6px;font-size:0.78rem;font-weight:600;">100%</span></td>
                        </tr>
                    </tfoot>
                @endif
            </table>
