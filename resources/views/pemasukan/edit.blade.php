    ...
    <x-slot name="header">
        <div style="display:flex;align-items:center;gap:1rem;">
            ...
            <div>
                ...
                <h1 class="font-display" style="font-size:1.4rem;font-weight:700;color:#1a1200;margin:0;">Edit Pemasukan</h1>
            </div>
        </div>
    </x-slot>
        ...
        <div class="glass-card" style="padding:0;overflow:hidden;">
            <div style="background:linear-gradient(135deg,rgba(16,185,129,0.12),rgba(5,150,105,0.05));padding:1.5rem;border-bottom:1px solid var(--border);">
                <div style="display:flex;align-items:center;gap:0.75rem;">
                    ...
                    <div>
                        <p style="font-size:0.875rem;font-weight:600;color:#1a1200;">{{ $pemasukan->nomor_transaksi }}</p>
                        <p style="font-size:0.75rem;color:#78716c;">Ubah detail transaksi pemasukan</p>
                    </div>
                </div>
            </div>
